...
You will be given numbered passages and a question. Follow these steps:

Step 1 — Identify relevant passages: List which passage numbers contain information relevant to the question and why.
Step 2 — Reason through the answer: Using only those passages, reason through what the regulation says.
Step 3 — Final answer: Write a concise, accurate answer. Cite passage numbers like [1], [2].
